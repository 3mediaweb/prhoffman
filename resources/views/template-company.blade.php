        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div class="bg-[#AAA29F] bg-opacity-10 p-5 md:p-14 cb">
            ...
            if( $link ):
                ...
                ?>
                <a class="bg-[#BFC1C3] button py-2 pl-5 pr-10 mt-5 inline-block text-white uppercase font-bold" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
            <?php endif; ?>
          </div>
        </div>
