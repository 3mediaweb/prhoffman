<footer class="grid clear-both grid-cols-1 md:grid-cols-4">
  ...
  <div class="col-span-3 bg-gray-300">
    ...
    <div class="w-full px-8 py-10 md:w-2/3">
        <div class="grid grid-cols-2 gap-10 lg:flex lg:flex-wrap lg:gap-0">
          <div class="mr-0 font-bold leading-tight text-center md:text-left lg:mr-14">
            <a href="/company-overview">Company Overiew</a>
          </div>
          <div class="mr-0 font-bold leading-tight text-center md:text-left lg:mr-14">
            <div>Products</div>
          ...
          <div class="mr-0 font-bold leading-tight text-center md:text-left lg:mr-14">
            ...
            <ul class="mt-5 font-normal text-gray-600">
              <li class="mb-2"><a href="/contact-us/#reps">Representatives</a></li>
              <li class="mb-2"><a href="/contact-us/#careers">Careers</a></li>
              <li class="mb-2"><a href="/contact-us/#form">Catalog Request</a></li>
              <li class="mb-2"><a href="/wp-content/uploads/PR-Hoffman_TC-Customers-012016.pdf" target="_blank">Terms & Conditions for Customers</a></li>
              <li class="mb-2"><a href="/wp-content/uploads/PR-Hoffman_TC-Vendors-012016.pdf" target="_blank">Terms & Conditions for Vendors</a></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="w-full bg-white md:w-1/3">
        <div class="px-12 py-10 md:pb-32">
          ...
          <ul>
            <li><?php the_field('contact_address', 'option') ; ?>,</li>
            <li>
              <?php the_field('contact_city', 'option') ; ?> <?php the_field('contact_state', 'option') ; ?>, <?php the_field('contact_country', 'option') ; ?> <?php the_field('contact_zip', 'option') ; ?>
            </li>
    ...
    <div class="flex flex-wrap justify-center px-5 py-4 pr-2 text-white md:justify-start md:pl-12 bg-purple">
      <div class="mb-3 md:pr-20 md:mb-0">&copy; <?php echo date("Y"); ?> PR Hoffman, Inc. All Rights Reserved.</div>
      <div class="flex justify-center flex-1 md:justify-end">
        <div class="flex">
          <?php if ( get_field('linkedin_url', 'option') ) : ?>
          <a class="mr-3 text-purple bg-white rounded-full duration-300 w-[30px] h-[30px] flex items-center justify-center" target="_blank" href="<?php the_field('linkedin_url', 'option'); ?>" aria-label="linkedin">
          ...
          <a class="mr-3 text-purple bg-white rounded-full duration-300 w-[30px] h-[30px] flex items-center justify-center" target="_blank" href="<?php the_field('twitter_url', 'option'); ?>" aria-label="instagram">
            <svg width="16px" class="h-5 fill-current" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"></path></svg>
          </a>
          <?php endif; ?>
          <?php if ( get_field('instagram_url', 'option') ) : ?>
          <a class="mr-3 text-purple bg-white rounded-full duration-300 w-[30px] h-[30px] flex items-center justify-center" target="_blank" href="<?php the_field('instagram_url', 'option'); ?>" aria-label="instagram">
          ...
          <a class="mr-3 text-purple bg-white rounded-full duration-300 w-[30px] h-[30px] flex items-center justify-center" target="_blank" href="<?php the_field('facebook_url', 'option'); ?>" aria-label="facebook">
          ...
          <?php if ( get_field('youtube_url', 'option') ) : ?>
            <a class="mr-3 text-purple bg-white rounded-full duration-300 w-[30px] h-[30px] flex items-center justify-center" target="_blank" href="<?php the_field('youtube_url', 'option'); ?>" aria-label="youtube">
