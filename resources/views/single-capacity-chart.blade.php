...
<section class="bg-center bg-cover min-h-[225px] pb-20" <?php if ($bg) : ?>style="background-image: url(<?php echo $bg; ?>);"<?php endif; ?>>
...
<div class="px-5 pt-10 pb-32 mx-auto max-w-7xl">
  ...
  @while(have_posts()) @php(the_post())
    @includeFirst(['partials.content-capacity-chart' . get_post_type(), 'partials.content-capacity-chart'])
  @endwhile
</div>
@endsection
